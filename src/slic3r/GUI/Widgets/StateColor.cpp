...
static std::map<wxColour, wxColour> gDarkColors{
    {"#FF5722", "#BF360C"}, // rgb(255, 87, 34)    ORCA color
    ...
    {"#FF7043", "#D84315"}, // rgb(255, 112, 67)   Button Confirm Color hover | ORCA Color Hover
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#FFD5C8", "#3D2A22"}, // rgb(255, 213, 200)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#FFEEE9", "#352621"}, // rgb(255, 238, 233)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
