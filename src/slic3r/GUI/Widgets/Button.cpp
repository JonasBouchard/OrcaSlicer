    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xFF8A65, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0xFF5722, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#FF5722", "#FF5722"};
wxString btn_confirm[10]  = {"#DFDFDF", "#FF5722", "#FF7043", "#FF5722", "#FF5722", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#FF8A65", "#FFCCBC"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#FF5722", "#FF5722"};
