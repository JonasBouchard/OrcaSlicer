...
int filament_index_from_zero_based(int index) { return index + (start_filament_index_at_1() ? 1 : 0); }

int filament_index_from_one_based(int index) { return start_filament_index_at_1() ? index : index - 1; }
