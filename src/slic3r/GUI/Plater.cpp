...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#FF5722");
...
{
    StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#FF5722"), StateColor::Normal));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bg_focus  = "#FFEEE9";
            wxColour bd_normal = "#DBDBDB";
            wxColour bd_hover  = "#FF5722";
            wxColour bd_focus  = "#FF5722";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#FF5722"), StateColor::Pressed),
                std::pair<wxColour, int>(wxColour("#FF5722"), StateColor::Hovered),
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#FF5722"));
