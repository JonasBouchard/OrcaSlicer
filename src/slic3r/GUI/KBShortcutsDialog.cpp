...
void KBShortcutsDialog::fill_shortcuts()
{
    ...
    if (wxGetApp().is_editor()) {
        ...
        const std::string filament_shortcut_range = zero_based_filament_indexing() ? L("0-9") : L("1-9");
        const std::string filament_shortcut_description = zero_based_filament_indexing()
